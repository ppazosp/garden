...
I'm here for the 0→1. Building what didn't exist yesterday, finding edges nobody bothered to push, shipping things that move something forward even a little. AI agents, infra, automation, open source: if it wasn't moving and now it is, I want to be part of it.
...
**Software Developer**  
Summer 2023 & 2024 · O Grove, Spain

Spotted a real-world operations problem, designed the solution, built it solo, shipped it, and supported 150+ users. The main project was a digital booking system for padel courts.

### USC

**B.Sc. Computer Engineering**  
2022 – 2026 · Santiago de Compostela
